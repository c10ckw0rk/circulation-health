		...
		function r(a, c) {
			return a === c
				...
				: a === b || c === b
					...
					: null === a || null === c
						? !1
						: a.constructor === String ? a + '' == c + '' : c.constructor === String ? c + '' == a + '' : !1;
		}
		function s(a, b, c) {
			var d, e, f;
			...
			(i = a(document)),
				...
				(c = O(Object, {
					...
					readonly: function(a) {
						a === b && (a = !1),
							this._readonly !== a &&
								((this._readonly = a), this.opts.element.prop('readonly', a), this.enableInterface());
					},
					opened: function() {
					...
					positionDropdown: function() {
						...
						u ? ((w = !0), !q && p && ((x = !0), (w = !1))) : ((w = !1), !p && q && ((x = !0), (w = !0))),
							x &&
								(b.hide(),
							...
							this.opts.dropdownAutoWidth
								? ((z = a('.select2-results', b)[0]),
								  ...
								  b.css('width', ''),
								  (r = b.outerWidth(!1) + (z.scrollHeight === z.clientHeight ? 0 : j.width)),
								  r > f ? (f = r) : (r = f),
								  (g = b.outerHeight(!1)))
										...
										e.opened() &&
											...
											c.more === !0
												? (b
														.detach()
														.appendTo(a)
														.html(e.opts.escapeMarkup(K(e.opts.formatLoadMore, e.opts.element, d + 1))),
												  window.setTimeout(function() {
														e.loadMoreIfNeeded();
												  }, 10))
												: b.remove(),
					...
					updateResults: function(c) {
						function m() {
							d.removeClass('select2-active'),
								h.positionDropdown(),
								e.find('.select2-no-results,.select2-selection-limit,.select2-searching').length
									? h.liveRegion.text(e.text())
									: h.liveRegion.text(
											h.opts.formatMatches(e.find('.select2-result-selectable:not(".select2-selected")').length)
									  );
						}
						function n(a) {
							e.html(a), m();
						...
						if (
							...
							if (
								...
								return (
									n("<li class='select2-selection-limit'>" + K(f.formatSelectionTooBig, f.element, o) + '</li>'), void 0
								);
									...
									J(f.formatInputTooShort, 'formatInputTooShort')
										? n(
												"<li class='select2-no-results'>" +
													K(f.formatInputTooShort, f.element, d.val(), f.minimumInputLength) +
													'</li>'
										  )
										: n(''),
							...
							if (f.maximumInputLength && d.val().length > f.maximumInputLength)
								return (
									J(f.formatInputTooLong, 'formatInputTooLong')
										? n(
												"<li class='select2-no-results'>" +
													K(f.formatInputTooLong, f.element, d.val(), f.maximumInputLength) +
													'</li>'
										  )
										: n(''),
									void 0
							...
							f.formatSearching &&
								...
								n("<li class='select2-searching'>" + K(f.formatSearching, f.element) + '</li>'),
									...
									callback: this.bind(function(g) {
										...
										if (l == this.queryCount) {
												...
												return (
													n(
														"<li class='select2-ajax-error'>" +
															K(f.formatAjaxError, f.element, g.jqXHR, g.textStatus, g.errorThrown) +
															'</li>'
													),
													void 0
												);
											if (
												...
												return (
													n("<li class='select2-no-results'>" + K(f.formatNoMatches, f.element, d.val()) + '</li>'),
													void 0
												);
											e.empty(),
												...
												g.more === !0 &&
													...
													(e.append(
														"<li class='select2-more-results'>" +
															f.escapeMarkup(K(f.formatLoadMore, f.element, this.resultsPage)) +
															'</li>'
													),
													window.setTimeout(function() {
														h.loadMoreIfNeeded();
							...
							if ('copy' === this.opts.width || 'resolve' === this.opts.width) {
								...
								return 'resolve' === this.opts.width
									? ((c = this.opts.element.css('width')),
									  c.indexOf('%') > 0
											? c
											: 0 === this.opts.element.outerWidth(!1) ? 'auto' : this.opts.element.outerWidth(!1) + 'px')
									: null;
							}
					...
					initContainer: function() {
						...
						this.opts.element.attr('title', h || g.text()),
							...
							b.on(
								...
								this.bind(function(a) {
									this.isInterfaceEnabled() &&
										(this.clear(), B(a), this.close(), this.selection && this.selection.focus());
								})
							),
							b.on(
								'mousedown touchstart',
						...
						if (this.isPlaceholderOptionSelected()) this.updateSelection(null), this.close(), this.setPlaceholder();
							...
							this.opts.initSelection.call(null, this.opts.element, function(a) {
								a !== b &&
									...
									c.close(),
									c.setPlaceholder(),
									(c.nextSearchTerm = c.opts.nextSearchTerm(a, c.search.val())));
							});
						}
					},
					...
					onSelect: function(a, b) {
						if (this.triggerSelect(a)) {
							...
							this.opts.element.val(this.id(a)),
								...
								r(c, this.id(a)) || this.triggerChange({ added: a, removed: d });
						}
					},
				...
				(e = O(c, {
							...
							this.search.on(
								...
								this.bind(function(a) {
									if (this.isInterfaceEnabled()) {
											...
											return (
												a.which == k.LEFT && d.length
													...
													: a.which == k.RIGHT
														? (g = e.length ? e : null)
														: a.which === k.BACKSPACE
															? this.unselect(b.first()) && (this.search.width(10), (g = d.length ? d : e))
															: a.which == k.DELETE
																? this.unselect(b.first()) && (this.search.width(10), (g = e.length ? e : null))
										...
										if (
											((a.which === k.BACKSPACE && 1 == this.keydowns) || a.which == k.LEFT) &&
											0 == f.offset &&
											!f.length
										)
											return (
												this.selectChoice(c.find('.select2-search-choice:not(.select2-locked)').last()), A(a), void 0
											);
							...
							this.opts.closeOnSelect
								...
								: this.countSelectableResults() > 0
									? (this.search.width(10),
									  this.resizeSearch(),
									  this.getMaximumSelectionSize() > 0 && this.val().length >= this.getMaximumSelectionSize()
											? this.updateResults(!0)
											: this.nextSearchTerm != b &&
					...
					getVal: function() {
						...
						return this.select
							...
							: ((a = this.opts.element.val()), s(a, this.opts.separator, this.opts.transformVal));
					},
					setVal: function(b) {
						var c;
						this.select
							...
							if (0 === c.length || 'object' == typeof c[0])
								(d = 0 === c.length ? {} : a.extend({}, c[0])),
									...
									'select' === d.element.get(0).tagName.toLowerCase()
										...
										: ((h = d.multiple || !1), 'tags' in d && (d.multiple = h = !0)),
								...
								if (
									...
									'container' === f
										? (g = e.container)
										: 'dropdown' === f ? (g = e.dropdown) : (l[f] && (f = l[f]), (g = e[f].apply(e, c.slice(1)))),
				...
				(a.fn.select2.defaults = {
					...
					text: function(b) {
						return b && this.data && this.data.text
							? a.isFunction(this.data.text) ? this.data.text(b) : b[this.data.text]
							: b.text;
					},
				...
				(a.fn.select2.locales.en = {
					formatMatches: function(a) {
						return 1 === a
							...
							: a + ' results are available, use up and down arrow keys to navigate.';
					},
