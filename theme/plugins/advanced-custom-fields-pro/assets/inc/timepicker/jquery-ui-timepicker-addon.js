			...
			if ($dp.find('div.ui-timepicker-div').length === 0 && o.showTimepicker) {
				var noDisplay = ' ui_tpicker_unit_hide',
					html =
						...
						(o.oneLine && o.controlType === 'select' ? ' ui-timepicker-oneLine' : '') +
						'"><dl>' +
				...
				if (typeof this.timezone !== 'undefined' && this.timezone !== null && this.timezone !== '') {
					var local_timezone =
						new Date(this.inst.selectedYear, this.inst.selectedMonth, this.inst.selectedDay, 12).getTimezoneOffset() *
						-1;
				...
				var hourMax = parseInt(
					...
					millisecMax = parseInt(
						this._defaults.millisecMax -
							(this._defaults.millisecMax - this._defaults.millisecMin) % this._defaults.stepMillisec,
						10
					),
					microsecMax = parseInt(
						this._defaults.microsecMax -
							(this._defaults.microsecMax - this._defaults.microsecMin) % this._defaults.stepMicrosec,
						10
					);
			...
			*/
			...
			if (!this._defaults.showTimepicker) {
				...
				var altFormattedDateTime = '',
					...
					altTimeSuffix =
						this._defaults.altTimeSuffix !== null ? this._defaults.altTimeSuffix : this._defaults.timeSuffix;
				...
				if (this._defaults.altTimeFormat !== null) {
					altFormattedDateTime +=
						$.datepicker.formatTime(this._defaults.altTimeFormat, this, this._defaults) + altTimeSuffix;
				} else {
			...
			select: {
				create: function(tp_inst, obj, unit, val, min, max, step) {
					...
					for (var i = min; i <= max; i += step) {
						...
						if (unit === 'hour') {
							sel += $.datepicker.formatTime($.trim(format.replace(/[^ht ]/gi, '')), { hour: i }, tp_inst._defaults);
			...
			if (altField) {
				...
				var altFormat = tp_inst._defaults.altFormat || tp_inst._defaults.dateFormat,
					...
					altTimeSuffix = tp_inst._defaults.altTimeSuffix
						...
						: tp_inst._defaults.timeSuffix,
					altTimeFormat =
						tp_inst._defaults.altTimeFormat !== null ? tp_inst._defaults.altTimeFormat : tp_inst._defaults.timeFormat;
	...
	$.datepicker.parseDate = function(format, value, settings) {
		...
		try {
			...
			if (err.indexOf(':') >= 0) {
				...
				$.timepicker.log(
					'Error parsing the date string: ' + err + '\ndate string = ' + value + '\ndate format = ' + format
				);
			} else {
				throw err;
			}
