	...
	if ((($.ui.timepicker = $.ui.timepicker || {}), !$.ui.timepicker.version)) {
		...
		$.extend(Timepicker.prototype, {
				...
				overrides = {
					...
					onChangeMonthYear: function(e, t, i) {
						$.isFunction(tp_inst._defaults.evnts.onChangeMonthYear) &&
							tp_inst._defaults.evnts.onChangeMonthYear.call($input[0], e, t, i, tp_inst);
					},
				...
				if (0 === e.find('div.ui-timepicker-div').length && t.showTimepicker) {
					var m = ' ui_tpicker_unit_hide',
						d =
							...
							(t.oneLine && 'select' === t.controlType ? ' ui-timepicker-oneLine' : '') +
					...
					for (u = 0, c = this.units.length; u < c; u++) {
						if (
							...
							(r[s] = parseInt(t[s + 'Max'] - (t[s + 'Max'] - t[s + 'Min']) % t['step' + n], 10)),
							(l[s] = 0),
							(d +=
							...
							if (((d += '<div style="padding-left: 1px"><table class="ui-tpicker-grid-label"><tr>'), 'hour' === s))
								for (var p = t[s + 'Min']; p <= r[s]; p += parseInt(t[s + 'Grid'], 10)) {
									l[s]++;
									var h = $.datepicker.formatTime(this.support.ampm ? 'hht' : 'HH', { hour: p }, t);
									d += '<td data-for="' + s + '">' + h + '</td>';
								}
							else
								for (var f = t[s + 'Min']; f <= r[s]; f += parseInt(t[s + 'Grid'], 10))
									l[s]++, (d += '<td data-for="' + s + '">' + (f < 10 ? '0' : '') + f + '</td>');
							d += '</tr></table></div>';
						}
						d += '</dd>';
					}
					var _ = null !== t.showTimezone ? t.showTimezone : this.support.timezone;
					(d += '<dt class="ui_tpicker_timezone_label' + (_ ? '' : m) + '">' + t.timezoneText + '</dt>'),
								...
								g
									...
									.click(function(e) {
										var t = $(this),
											...
											l = t.data('for');
										'hour' === l &&
											(r.indexOf('p') !== -1 && a < 12 ? (a += 12) : r.indexOf('a') !== -1 && 12 === a && (a = 0)),
					...
					if (
						...
						this.$timeObj.change(function() {
							var e = i.inst.settings.timeFormat,
								...
								s = new Date();
							t
								? (s.setHours(t.hour), s.setMinutes(t.minute), s.setSeconds(t.second), $.datepicker._setTime(i.inst, s))
						...
						this.hour < o.getHours()
							...
							: this.hour === o.getHours() && this.minute < o.getMinutes()
								...
								: this._defaults.hourMin < o.getHours()
									? ((this._defaults.hourMin = o.getHours()), (this._defaults.minuteMin = o.getMinutes()))
									: (this._defaults.hourMin === o.getHours()) === this.hour && this._defaults.minuteMin < o.getMinutes()
						...
						this.hour > u.getHours()
							...
							: this.hour === u.getHours() && this.minute > u.getMinutes()
								...
								: this._defaults.hourMax > u.getHours()
									? ((this._defaults.hourMax = u.getHours()), (this._defaults.minuteMax = u.getMinutes()))
									: (this._defaults.hourMax === u.getHours()) === this.hour && this._defaults.minuteMax > u.getMinutes()
			...
			_onTimeChange: function() {
				if (this._defaults.showTimepicker) {
					var e = !!this.hour_slider && this.control.value(this, this.hour_slider, 'hour'),
						...
						n = !!this.microsec_slider && this.control.value(this, this.microsec_slider, 'microsec'),
					...
					var u = r[e < 12 ? 'amNames' : 'pmNames'][0],
						c =
							...
							(this.ampm.length > 0 && e < 12 != ($.inArray(this.ampm.toUpperCase(), this.amNames) !== -1)) ||
			...
			_updateDateTime: function(e) {
				...
				if (
					...
					this._defaults.timeOnly === !0 && this._defaults.timeOnlyShowDate === !1
						...
						: ((this._defaults.timeOnly !== !0 && (this._defaults.alwaysSetTime || a)) ||
								(this._defaults.timeOnly === !0 && this._defaults.timeOnlyShowDate === !0)) &&
						  (r += this._defaults.separator + this.formattedTime + this._defaults.timeSuffix),
					...
					if (this.$altInput && this._defaults.timeOnly === !1 && this._defaults.altFieldTimeOnly === !0)
						...
						this._defaults.timeOnly ||
							((l = this._defaults.altFormat
								? $.datepicker.formatDate(this._defaults.altFormat, null === i ? new Date() : i, n)
								: this.formattedDate),
							l && (l += o)),
							(l +=
								null !== this._defaults.altTimeFormat
									? $.datepicker.formatTime(this._defaults.altTimeFormat, this, this._defaults) + u
				...
				slider: {
					create: function(e, t, i, s, n, a, r) {
						...
						return t.prop('slide', null).slider({
							...
							step: r,
							slide: function(t, s) {
								e.control.value(e, $(this), i, l ? s.value * -1 : s.value), e._onTimeChange();
							},
							stop: function(t, i) {
								e._onSelectHandler();
							}
					...
					options: function(e, t, i, s, n) {
						if (e._defaults.isRTL) {
							if ('string' == typeof s)
								return 'min' === s || 'max' === s
									? void 0 !== n ? t.slider(s, n * -1) : Math.abs(t.slider(s))
									: t.slider(s);
							var a = s.min,
								r = s.max;
							return (
								(s.min = s.max = null), void 0 !== a && (s.max = a * -1), void 0 !== r && (s.min = r * -1), t.slider(s)
							);
						}
					...
					value: function(e, t, i, s) {
						return e._defaults.isRTL
							? void 0 !== s ? t.slider('value', s * -1) : Math.abs(t.slider('value'))
							: void 0 !== s ? t.slider('value', s) : t.slider('value');
					}
				},
				select: {
					create: function(e, t, i, s, n, a, r) {
						for (
							...
							(l += '<option value="' + u + '"' + (u === s ? ' selected' : '') + '>'),
								(l +=
									'hour' === i
										? $.datepicker.formatTime($.trim(o.replace(/[^ht ]/gi, '')), { hour: u }, e._defaults)
										: 'millisec' === i || 'microsec' === i || u >= 10 ? u : '0' + u.toString()),
								(l += '</option>');
						return (
							(l += '</select>'),
			...
			$.fn.extend({
				...
				datetimepicker: function(e) {
					...
					return 'string' == typeof e
						? 'getDate' === e || ('option' === e && 2 === t.length && 'string' == typeof t[1])
			...
			($.datepicker.parseTime = function(e, t, i) {
					...
					a = function(e, t, i) {
							...
							n = function(e) {
								...
								if (t)
									for (var s = 0; s < t.length; s++)
										i[t[s].toString().charAt(0)] === -1 && (i[t[s].toString().charAt(0)] = s + 1);
								return i;
							},
							a =
								'^' +
								e
									.toString()
									.replace(/([hH]{1,2}|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|'.*?')/g, function(e) {
										var t = e.length;
										switch (e.charAt(0).toLowerCase()) {
											...
											default:
												return (
													'(' +
													e.replace(/\'/g, '').replace(/(\.|\$|\^|\\|\/|\(|\)|\[|\]|\?|\+|\*)/g, function(e) {
														return '\\' + e;
													}) +
													')?'
												);
						...
						return (
							...
							r.h !== -1 &&
								('AM' === l && '12' === o[r.h]
									? (u.hour = 0)
									: 'PM' === l && '12' !== o[r.h] ? (u.hour = parseInt(o[r.h], 10) + 12) : (u.hour = Number(o[r.h]))),
							r.m !== -1 && (u.minute = Number(o[r.m])),
							r.s !== -1 && (u.second = Number(o[r.s])),
							r.l !== -1 && (u.millisec = Number(o[r.l])),
							r.c !== -1 && (u.microsec = Number(o[r.c])),
							r.z !== -1 && void 0 !== o[r.z] && (u.timezone = $.timepicker.timezoneOffsetNumber(o[r.z])),
							u)
						);
					},
					r = function(e, t, i) {
						try {
							...
							if (
								...
								isNaN(s.getTime()) && ((s = new Date('01/01/2012 ' + t)), isNaN(s.getTime())))
							)
				...
				return 'function' == typeof s.parse ? s.parse(e, t, s) : 'loose' === s.parse ? r(e, t, s) : a(e, t, s);
			}),
			($.datepicker.formatTime = function(e, t, i) {
				(i = i || {}),
					(i = $.extend({}, $.timepicker._defaults, i)),
					(t = $.extend({ hour: 0, minute: 0, second: 0, millisec: 0, microsec: 0, timezone: null }, t));
				var s = e,
					n = i.amNames[0],
				...
				if (t) {
					...
					if (i) {
						var s = t._defaults.altFormat || t._defaults.dateFormat,
							...
							r = '',
							l = t._defaults.altSeparator ? t._defaults.altSeparator : t._defaults.separator,
							o = t._defaults.altTimeSuffix ? t._defaults.altTimeSuffix : t._defaults.timeSuffix,
							u = null !== t._defaults.altTimeFormat ? t._defaults.altTimeFormat : t._defaults.timeFormat;
			...
			($.datepicker._gotoToday = function(e) {
				...
				if (i) {
					var s = $.timepicker.timezoneOffsetNumber(i.timezone),
						n = new Date();
					n.setMinutes(n.getMinutes() + n.getTimezoneOffset() + parseInt(s, 10)),
						this._setTime(t, n),
						this._setDate(t, n),
						i._onSelectHandler();
				}
			...
			($.datepicker._disableTimepickerDatepicker = function(e) {
				...
				if (t) {
					...
					$(e).datepicker('getDate'),
						i && ((t.settings.showTimepicker = !1), (i._defaults.showTimepicker = !1), i._updateDateTime(t));
				}
			}),
					...
					if (n) {
						...
						t &&
							('string' == typeof t
								...
								: ((a = new Date(t.getTime())), a.setMicroseconds(t.getMicroseconds())),
			...
			($.datepicker._setDateDatepicker = function(e, t) {
				...
				if (i) {
					'string' == typeof t &&
						((s = new Date(t)),
						s.getTime() || (this._base_setDateDatepicker.apply(this, arguments), (s = $(e).datepicker('getDate'))));
					var n = this._get(i, 'timepicker'),
						a;
					s instanceof Date ? ((a = new Date(s.getTime())), a.setMicroseconds(s.getMicroseconds())) : (a = s),
						n &&
							a &&
							(n.support.timezone || null !== n._defaults.timezone || (n.timezone = a.getTimezoneOffset() * -1),
						...
						return (
							(a =
								s.$altInput && s._defaults.altFieldTimeOnly
									...
									: 'INPUT' !== s.$input.get(0).tagName && s.$altInput ? s.$altInput.val() : s.$input.val()),
							n &&
								s._parseTime(a, !i.settings.timeOnly) &&
								(n.setHours(s.hour, s.minute, s.second, s.millisec),
								n.setMicroseconds(s.microsec),
								null != s.timezone &&
									(s.support.timezone || null !== s._defaults.timezone || (s.timezone = n.getTimezoneOffset() * -1),
			...
			($.datepicker.parseDate = function(e, t, i) {
				...
				try {
					...
					(s = this._base_parseDate(e, t.substring(0, t.length - (n.length - n.indexOf(':') - 2)), i)),
						$.timepicker.log('Error parsing the date string: ' + n + '\ndate string = ' + t + '\ndate format = ' + e);
				}
				return s;
			}),
				...
				if (a) {
					...
					if ('string' == typeof t) {
						...
						t.minDate
							...
							: t.minDateTime
								? (r = t.minDateTime)
								: t.maxDate ? (l = t.maxDate) : t.maxDateTime && (l = t.maxDateTime);
						for (m in u) u.hasOwnProperty(m) && t[m] && (c[m] = t[m]);
					}
					for (m in c) c.hasOwnProperty(m) && ((u[m] = c[m]), n || (n = $.extend({}, t)), delete n[m]);
					if (n && isEmptyObject(n)) return;
					if (
						(r
							? ((r = 0 === r ? new Date() : new Date(r)), (a._defaults.minDate = r), (a._defaults.minDateTime = r))
							: l
								? ((l = 0 === l ? new Date() : new Date(l)), (a._defaults.maxDate = l), (a._defaults.maxDateTime = l))
						...
						return (
							...
							(d = this._base_optionDatepicker.call($.datepicker, e, n || t, i)),
		...
		var isEmptyObject = function(e) {
			...
			splitDateTime = function(e, t) {
				var i = computeEffectiveSetting(t, 'separator'),
					...
					l = r.length;
				return l > 1
					? { dateString: r.splice(0, l - a).join(i), timeString: r.splice(0, a).join(i) }
					: { dateString: e, timeString: '' };
			},
			parseDateTimeInternal = function(e, t, i, s, n) {
				var a, r, l;
				if (((r = splitDateTime(i, n)), (a = $.datepicker._base_parseDate(e, r.dateString, s)), '' === r.timeString))
					return { date: a };
		...
		($.timepicker = new Timepicker()),
			...
			($.timepicker.timezoneOffsetNumber = function(e) {
				...
				return 'Z' === t.toUpperCase()
					? 0
					: /^(\-|\+)\d{4}$/.test(t)
						? ('-' === t.substr(0, 1) ? -1 : 1) * (60 * parseInt(t.substr(1, 2), 10) + parseInt(t.substr(3, 2), 10))
						: parseInt(e, 10);
			}),
				...
				function n(n, a) {
					...
					if (null !== r) {
						...
						u.setMilliseconds(u.getMilliseconds() + s.minInterval),
							...
							s.minInterval > 0 && u > l
								? i[e]('setDate', u)
								: s.maxInterval > 0 && c < l ? i[e]('setDate', c) : r > l && a[e]('setDate', o);
					}
				}
				function a(t, i, n) {
					if (t.val()) {
						...
						null !== a &&
							s.minInterval > 0 &&
							('minDate' === n && a.setMilliseconds(a.getMilliseconds() + s.minInterval),
							'maxDate' === n && a.setMilliseconds(a.getMilliseconds() - s.minInterval)),
			...
			Date.prototype.getMicroseconds ||
				...
				(Date.prototype.setMicroseconds = function(e) {
					return (
						this.setMilliseconds(this.getMilliseconds() + Math.floor(e / 1e3)), (this.microseconds = e % 1e3), this
					);
				})),
