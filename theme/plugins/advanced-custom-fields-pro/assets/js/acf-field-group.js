(function($) {
		...
		*/
		...
		render_rule: function($tr, triggers) {
			...
			if (field_type == 'true_false') {
				...
				// vars
				var lines = $field
					.find('.acf-field[data-name="choices"] textarea')
					.val()
					.split('\n');
	...
	var acf_settings_select = acf.field_group.field_object.extend({
		...
		render: function($el) {
			...
			if (this.setting('ui input[type="checkbox"]').prop('checked')) {
				...
				this.setting('ajax input[type="checkbox"]')
					.prop('checked', false)
					.trigger('change');
			}
		}
	...
	var acf_settings_radio = acf.field_group.field_object.extend({
		...
		render: function($el) {
			...
			if (this.setting('other_choice input[type="checkbox"]').prop('checked')) {
				...
				this.setting('save_other_choice input[type="checkbox"]')
					.prop('checked', false)
					.trigger('change');
			}
		}
	...
	var acf_settings_checkbox = acf.field_group.field_object.extend({
		...
		render: function($el) {
			...
			if (this.setting('allow_custom input[type="checkbox"]').prop('checked')) {
				...
				this.setting('save_custom input[type="checkbox"]')
					.prop('checked', false)
					.trigger('change');
			}
		}
	...
	*/
	...
	var acf_settings_tab = acf.field_group.field_object.extend({
		...
		render: function($el) {
			// clear name
			this.setting('name input')
				.val('')
				.trigger('change');

			// clear required
			this.setting('required input[type="checkbox"]')
				.prop('checked', false)
				.trigger('change');
		}
	});
